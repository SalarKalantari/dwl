...
static const float focuscolor[]            = COLOR(0x4e4e4eff);
...
static const MonitorRule monrules[] = {
	...
	*/
	/* defaults */
	{ "eDP-1",      0.55f, 1,      1,    &layouts[0], WL_OUTPUT_TRANSFORM_NORMAL,   320,  1440 },
	{ "DP-3",       0.60f, 1,      1.5,    &layouts[0], WL_OUTPUT_TRANSFORM_NORMAL,   0,  0 },
	{ "DP-4",       0.60f, 1,      1.5,    &layouts[0], WL_OUTPUT_TRANSFORM_NORMAL,   0,  0 },
...
static const Key keys[] = {
  ...
  /* Hardware keys for dwl (Wayland keysyms) */
  ...
  // { 0, XKB_KEY_XF86MonBrightnessUp,   spawn, SHCMD("xbacklight -inc 5") },
